...
assumed_role_object = sts_client.assume_role(
    RoleArn="arn:aws:iam::578120814996:role/glue-refresher-full-course",
...
# Use the Amazon S3 resource object that is now configured with the credentials to access your S3 buckets.
